...
let pulledLetters = []; // track number of letters pulled 
...
const findLetter = () => {
    ...
    pulledLetters.push(returnedLtr) // push to empty array

    //logic would go above this before return

...
/*
    denoted with: "..."
    - pulls out all the elements of an array and gives them to you
        as one stand alone list of elements.
*/
...
fullName.push("Mrs.");
console.log(`Origianal:`, fullName, "Spread: ", copiedFullName);

//* with Numbers
console.log(Math.min(1, 5, -3)); // returns the smallest number(min)

const prices = [10.99, 5.99, 3.99, 6.59];
console.log(Math.min(prices)); // NaN
console.log(Math.min(...prices)); // 3.99

// Anytime that you are working with a function / method that requires stand
//alone values, spread op. helps get these values out of an array.
